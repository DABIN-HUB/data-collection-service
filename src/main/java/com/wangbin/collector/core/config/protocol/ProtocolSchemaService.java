    ...
    private ProtocolSchema opcUa() {
        return schema("OPC_UA", "OPC UA", "OPC Unified Architecture client.",
                ...
                fields(
                        ...
                        field("securityPolicy", "select", "Security policy", true, "None",
                                List.of("None", "Basic128Rsa15", "Basic256", "Basic256Sha256",
                                        "Aes128_Sha256_RsaOaep", "Aes256_Sha256_RsaPss"),
                                "security"),
                        field("securityMode", "select", "Security mode", true, "None",
                                List.of("None", "Sign", "SignAndEncrypt"), "security"),
                        field("authType", "select", "Authentication type", true, "ANONYMOUS",
                        ...
                        conditional("clientCertPath", "string", "Client certificate path", false, "", null,
                                "security", "authType=CERT or securityPolicy!=None"),
                        field("clientCertPassword", "password", "Client certificate password", false, "", null, "security"),
                        field("trustAllServerCert", "boolean", "Trust all server certificates", false, "false",
